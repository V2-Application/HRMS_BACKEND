...
{
    public class EmpAttendanceViewSnapshotRequestDto
    {
        public string? Month { get; set; } // Optional: MMM-YY format
        public int? Status { get; set; } // Optional: default 1
    }

    public class EmpAttendanceViewSnapshotResponseDto
    {

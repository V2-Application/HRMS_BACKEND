...
-- =========================================================================
CREATE OR ALTER PROCEDURE [dbo].[usp_InsertEmployeeAfterInitiate01]
      @CandidateId bigint,
  ...
  BEGIN
      ...
      BEGIN
          INSERT INTO tblEmployee(
              ...
              DepartmentId, DesignationId, LocationId, DOJ, Ecode, LastUpdatedBy,
          ...
          VALUES (
              ...
              @DepartmentId, @DesignationId, @LocationId, ISNULL(@DOJ, GETDATE()), @NewEcode, @UpdatedBy,

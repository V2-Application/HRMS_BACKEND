ALTER PROCEDURE [dbo].[usp_GetMonthlyPunchesRange_Optimized_new_2]  -- '2026-02-26','2026-03-25','v41797'      
(      
    @FromDate DATE,      
    @ToDate   DATE,      
...
BEGIN      
    ...
    DECLARE @HalfDayMinutes INT = 270;    -- olv value 240  
        ...
        */      
        ...
        LateMinutes =      
            CASE      
                ...
                WHEN ec.UsedInDT > ef.ShiftStartDT THEN DATEDIFF(MINUTE, ec.UsedInDT, ef.EffectiveInDT)      
                ELSE 0      
            END,      

-- Updated stored procedure with salary fields and optional Ecode parameter
    ...
    BEGIN TRY                
        ...
        (              
           ...
           -- ESICNO,      
            ...
            [From], [To],   -- New columns
            BasicSalary, CCA, DA, ExtraAllowance, SpecialAllowance, HRA, -- Salary columns
            [GROSS SALARY], monthlyGrossCTC, annuallyNetCTC -- Additional salary columns          
        )              
        VALUES              
        (              
     ...
     @EMAIL_ADDRESS, @MOBILE,              
           ...
           -- @UAN_NO,      
            ...
            @BasicSalary, @CCA, @DA, @ExtraAllowance, @SpecialAllowance, @HRA, -- Salary values
            @GROSS_SALARY, @monthlyGrossCTC, @annuallyNetCTC -- Additional salary values                 
        );              

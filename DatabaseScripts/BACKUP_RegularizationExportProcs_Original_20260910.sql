/* Original definitions of the two regularization export procs, taken from dev
   before Add_RegularizeHrApprovalLayer_20260910.sql was applied. Restore by
   running these bodies with CREATE OR ALTER. */

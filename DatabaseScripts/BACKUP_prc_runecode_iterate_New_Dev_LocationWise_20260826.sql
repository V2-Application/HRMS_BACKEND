CREATE PROCEDURE [dbo].[prc_runecode_iterate_New_Dev_LocationWise]           
    @MonthKey NVARCHAR(7),          -- Example: 'Sep-25'          
    @STCode NVARCHAR(7),          -- Example: 'Sep-25'          
...
BEGIN          
    ...
    END          
        --update employee attendance 26-25 cycle  
   Exec usp_MergeEmpAttendanceFromMonthlySummary_Single_Dev @MonthKey,null     
    ...
    Left Join tblLocation c on c.LocationId=a.LocationId    
    WHERE           
        (    
  ...
  ;    
            ...
            WHEN NOT EXISTS (        
              ...
              OR EXISTS (        
                   ...
                   FROM (        
                     ...
                     FROM EmpAttendanceViewSnapshot                             WHERE Ecode = @EmployeeId AND [Month] = @MonthKey        
                     ORDER BY ID DESC        
                   ) t        
    ...
    --Exec usp_MergeEmpAttendanceFromMonthlySummary_Single_Dev @MonthKey,@EmployeeId     

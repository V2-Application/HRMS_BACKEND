...
BEGIN
    ...
    */
    ...
    SELECT
        ...
        CASE WHEN COALESCE(sep.SeparationDate, e.UpdatedOn, e.DateOfLeft) IS NULL THEN NULL
             ELSE DATEDIFF(DAY, CAST(COALESCE(sep.SeparationDate, e.UpdatedOn, e.DateOfLeft) AS date), @ToDate) END AS [SEPERATION AGEING],

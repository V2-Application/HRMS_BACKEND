...
public partial class vw_Emp_Attendance_Format_Amit
{
    ...
    public string BasicSalary_Bud__ { get; set; }

    public string HRA_Bud__ { get; set; }

    public string CCA_Bud__ { get; set; }

    public string SpecialAllowance_Bud__ { get; set; }

    public string DA_Bud__ { get; set; }
    ...
    public string Monthly_Gross_CTC_Bud__ { get; set; }

...
public partial class tblAttendanceRegularizationRequest
{
    ...
    public virtual tblEmployee LpApprover { get; set; }

    public virtual tblStatus ManagerApprovalStatus { get; set; }

    public virtual tblEmployee ManagerApprover { get; set; }

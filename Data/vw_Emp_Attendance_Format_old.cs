...
public partial class vw_Emp_Attendance_Format_old
{
    ...
    public int? ttl_bgt_days { get; set; }

    public int? actualttl_days { get; set; }
    ...
    public decimal? Monthly_Gross_CTC_Actual_After_Deduction_ { get; set; }

    public decimal? Payble_Days { get; set; }

    public decimal? Leave_Used { get; set; }

    public double? Opening_EL { get; set; }
    ...
    public double? Opening_CL { get; set; }

...
namespace HRMSAPI.Controllers
{
    ...
    public class GapReportsController : ControllerBase
    {
        ...
        public IActionResult List()
        {
            var list = new[]
            {
                new { key = "location", name = "Location-wise Absconding Report", category = "Absconding" },
                new { key = "employee", name = "Employee-wise Absconding Report", category = "Absconding" },
                new { key = "mispunch", name = "TD/MTD Mis-Punch Gap Report (Employee-wise)", category = "Attendance" },
                new { key = "mispunch-loc", name = "TD/MTD Mis-Punch Gap Report (Location-wise)", category = "Attendance" },
                new { key = "geofence-loc", name = "TD/MTD Geo-Fencing Gap Report (Location-wise)", category = "Attendance" },
                new { key = "geofence-emp", name = "TD/MTD Geo-Fencing Gap Report (Employee-wise)", category = "Attendance" },
                new { key = "regularization-loc", name = "TD/MTD Regularization Gap Report (Location-wise)", category = "Attendance" },
                new { key = "regularization-emp", name = "TD/MTD Regularization Gap Report (Employee-wise)", category = "Attendance" },
                new { key = "lastpunch-sep", name = "Last Punch vs Separation High Ageing Gap Report", category = "Separation" },
                new { key = "lastpunch-after-sep", name = "Last Punching Shows After Separation Gap Report", category = "Separation" },
                new { key = "sep-fnf-pending", name = "Separated But F&F Pending Gap Report", category = "Separation" },
                new { key = "sep-lastpunch-missing", name = "Separated But Last Punch Date Missing Gap Report", category = "Separation" },
                new { key = "sep-resignation-missing", name = "Separated But Resignation Missing Gap Report", category = "Separation" },
                new { key = "rm-geofence-pending", name = "TD/MTD RM Geo-Fencing Approval Pending Gap Report", category = "Approval Pending" },
                new { key = "rm-regularization-pending", name = "TD/MTD RM Regularization Approval Pending Gap Report", category = "Approval Pending" },
                new { key = "audit-regularization-pending", name = "TD/MTD Audit Regularization Approval Pending Gap Report", category = "Approval Pending" },
                new { key = "absent-loc", name = "Location-wise Absent TD/MTD Gap Report", category = "Attendance" },
                new { key = "actemp-vs-attend-loc", name = "Location-wise Act Emp vs Act Attendance Gap Report", category = "Manpower / Budget" },
                new { key = "bgtemp-vs-attend-loc", name = "Location-wise Bgt Emp vs Act Emp Gap Report", category = "Manpower / Budget" },
                new { key = "bgtemp-vs-actattend-loc", name = "Location-wise Bgt Emp vs Act Attendance Gap Report", category = "Manpower / Budget" },

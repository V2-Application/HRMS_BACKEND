-- LIVE PROD definition of dbo.proc_BGTSEATMASTER captured 2026-07-23 BEFORE the EXCESS-ACTIVE fix.
-- Restore this verbatim (as CREATE OR ALTER) to revert.
...
Matched AS (
    SELECT COALESCE(e.STCode, s.LOC_CODE) AS STCode, COALESCE(e.DepartmentId, s.DEPT_SNO) AS DepartmentId,
        ...
        e.ReportDesig, e.ActualSalary, s.SEAT_MASTER_NO, s.SALARY_BGT, s.ReportingDesig, s.ACTIVE,
        s.SubDepartment1, s.SubDepartment2, s.SubDepartment3,
